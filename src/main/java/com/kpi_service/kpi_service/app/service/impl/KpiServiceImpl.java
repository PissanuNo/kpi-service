...
public class KpiServiceImpl implements KpiService {
    ...
    public ResponseBodyModel<String> addKpiEmployee(AddKpiEmployeeRequest request) {
        ...
        try {
            ...
            Integer kpiEmployeeId = UUID.randomUUID().hashCode();

            KpiEmployeeModel model = kpiEmployeeRepository.saveAndFlush(KpiEmployeeModel.builder()
            ...
            EmployeeResponse result = kpiSmrServiceClient.createEmployee(CreateEmployeeRequest.builder()
                    ...
                    .Employee(EmployeeRequest.builder()
                            ...
                            .build())
                    .AccessLevel(model.getAccesslevelModel().getDataDetailEn())
                    .UserGroup(model.getUserGroupModel().getDataDetailEn())
                    .build());
    ...
    private Integer updateCorporate(String corporateId) {
        ...
        if (corporateModel.isPresent()) {
            ...
            kpiCorporateId = UUID.randomUUID().hashCode();
